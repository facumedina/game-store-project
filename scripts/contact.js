function register(event) {
  ...
  params = {
    ...
    // reply_to: `facurmedina@gmail.com`
  }
  
  emailjs.send('service_cocsh87', 'template_jbus0xp', params)
    .then((resp) => swal ("El formulario ha sido enviado correctamente.","En breve nos pondremos en contacto para resolver su consulta", "success"))
